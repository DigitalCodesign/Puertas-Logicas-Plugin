/**
 * LogicGatesFlipFlopJK.h - Librería para compatibilizar funcionamiento del Entrenador de Puertas
 * Logicas con MentorBit.
 * 
 * Creado el 18/10/2024 - ingenieria@digitalcodesign.com
 * 
 * Declaración de atributos y métodos para la clase LogicGatesFlipFlopJK, referida
 * a la gestión de Flip Flops de tipo JK.
 */
